...
contract("AngelNFT", function (accounts) {
    ...
    before( async () => {
        ...
        tx = await nft.mintNFT('https://angel.com', { from: walletA })
        NFTCA = nft.address;
        SALECA = sale.address;
        //tokenId value 1
    ...
    describe("TestCase3 : 민팅된 NFT의 transfer approve || 민팅된 NFT의 거래 컨트랙트 판매 등록 ",() => {
        ...
        it('tokenId 1값을 10eth로 설정하기', async () => {
            ...
            //const tokenPrice = Number(web3.utils.fromWei(rawTokenPrice.toString())); 
